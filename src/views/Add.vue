<template>
    <div
        class="flex justify-center text-[10px] items-center h-full w-full flex-col gap-2"
    >
            ...
            <div class="flex flex-col w-full p-4">
                ...
                >
                    <div class="grid md:grid-cols-2 grid-cols-1">
                        ...
                        <div class="text-slate-800 p-4 flex flex-col gap-2">
                            <label for="Jours" class="font-semibold"
                                >Nombre du Jour
                            </label>
                            <div
                                class="flex items-center gap-2 shadow-2xl border-2 border-dashed p-2 rounded-xl"
                        ...
                        <div class="text-slate-800 p-4 flex flex-col gap-2">
                            <label for="Tarif" class="font-semibold"
                                >Tarif journalier
                            </label>
                            <div
                                class="flex items-center gap-2 shadow-2xl border-2 border-dashed p-2 rounded-xl"
        ...
        <div class="w-96 h-10 flex justify-center items-center rounded-lg mt-5">
            <p
                v-if="error"
                class="bg-red-300 px-4 py-2 rounded-lg text-red-600"
            >
                {{ error }}
            </p>
            <p
