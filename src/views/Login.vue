<template>
    <div class="flex justify-center items-center h-screen w-full">
       <div class="bg-slate-200 p-6 rounded-lg w-[30%] flex justify-center items-center flex-col gap-7 shadow-lg">
            ...
            <form action="" @submit.prevent="handleLogin" class="w-full h-full flex flex-col gap-5">
                ...
                <div class="flex justify-between">
                    <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-lg duration-500 hover:bg-blue-900 font-semibold shadow">Login</button>
                    <router-link to="/inscription" class="ml-4 text-blue-500 hover:underline">
                        S'inscrire
                    </router-link>
                </div>
                <div>
...
const handleLogin = async () => {
    ...
    try {
        ...
        console.log("Donnees recus :", res.data);
