<template>
    ...
    <div class="w-full text-[10px] min-h-screen flex justify-center items-center bg-slate-50">
        <div :class="[
        ...
        <div id="box"
            ...
            <div id="box2"
                ...
                <form @submit.prevent="Valider" class="w-full flex flex-col max-w-100 gap-3">
                    <div class="flex flex-col gap-1">
                        <div :class="[
                            ...
                            <input type="text" @input="valideNom" placeholder="Entrer votre nom"
                                class="outline-none w-full bg-transparent" v-model="Nom" />
                        </div>
                        <span v-if="ErrorNom" class="ml-3 text-red-500 text-xs">{{ ErrorNom }}</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <div :class="[
                            ...
                            <input type="text" @input="validePrenom" placeholder="Entrer votre prénom"
                                class="outline-none w-full bg-transparent" v-model="Prenom" />
                        </div>
                        <span v-if="ErrorPrenom" class="ml-3 text-red-500 text-xs">{{ ErrorPrenom }}</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <div :class="[
                            ...
                            <input type="email" @input="valideEmail" placeholder="Entrer votre email"
                                class="outline-none w-full bg-transparent" v-model="Email" />
                        </div>
                        <span v-if="ErrorEmail" class="ml-3 text-red-500 text-xs">{{ ErrorEmail }}</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <div :class="[
                            ...
                            <input @input="validePwd" :type="viewPwd ? 'text' : 'password'"
                                placeholder="Créer votre mot de passe" class="outline-none w-full bg-transparent"
                                v-model="Pwd" />
                        </div>
                        <span v-if="ErrorPwd" class="ml-3 text-red-500 text-xs">{{ ErrorPwd }}</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <div :class="[
                            ...
                            <input @input="valideConfirmPwd" :type="viewPwd ? 'text' : 'password'"
                                placeholder="Confirmer votre mot de passe" class="outline-none w-full bg-transparent"
                                v-model="ConfirmPwd" />
                        </div>
                        <span v-if="ErrorConfirmPwd" class="ml-3 text-red-500 text-xs">{{ ErrorConfirmPwd }}</span>
                    </div>

                    <div class="flex items-center gap-2 ml-3">
                        <input id="check" v-model="viewPwd" class="cursor-pointer accent-slate-700" type="checkbox" />
                        <label for="check" class="text-xs text-slate-500 cursor-pointer">Afficher le mot de
                            passe</label>
                    </div>
                ...
                <div class="border-t-2 border-slate-500/30 w-full p-2">
                    <p class="text-xs text-slate-600">
                        J'ai déjà un compte ?
                        <router-link class="text-blue-400 cursor-pointer hover:underline" to="/login">Se
